...
global frame, cropped, croppedgrab
"""
...
def main():
    ...
    block_execute_btn = [
        [sg.Button('딥러닝', button_color=('white', 'black'), key='start'),
         sg.Button('TESSERACT', button_color=('white', 'black'), key='stop'),
         sg.Button('유사이미지', button_color=('white', 'firebrick3'), key='reset'),
         sg.Button('품목분류', button_color=('white', 'springgreen4'), key='submit')]
    ]
    layout = [
        ...
        [sg.Column([
                    ...
                    ,[sg.Column(block_execute_btn, size=(800, 250), pad=(10, 10))]
                    ],
